...
class WC_Box_Office_Email extends WC_Email {
	...
	public function __construct() {
		...
		$this->description    = __( 'Box Office emails are sent to the contact address for each ticket whenever a ticket is purchased or updated.', 'woocommerce-box-office' );
